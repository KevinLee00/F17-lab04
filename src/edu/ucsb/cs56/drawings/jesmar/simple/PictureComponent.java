package edu.ucsb.cs56.drawings.jesmar.simple;
...
/**
   ...
   @author Jesmar Castillo (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Wicked sick snowman and crib, Jesmar Castillo", 20,20);
