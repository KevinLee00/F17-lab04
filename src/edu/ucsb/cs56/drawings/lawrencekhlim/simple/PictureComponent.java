package edu.ucsb.cs56.drawings.lawrencekhlim.simple;
...
/**
   ...
   @author Lawrence Lim (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Cookie Cutter Snowman by Lawrence Lim", 20,20);
