...
public class AllMyDrawings
{
	...
	SoccerBall b1 = new SoccerBall(100,250,113,113);
	g2.setColor(Color.CYAN); g2.draw(b1);
	
	// Make a soccer ball that's half the size, 
	...
	// Makes a soccer ball that's 4x as big (2x the original)
	...
	// Draw two SoccerBalls
	
	SoccerBall ball1 = new SoccerBall(300,300,200,200);
	SoccerBall ball2 = new SoccerBall(40,45,130,130);
	g2.draw(ball1);
	...
	g2.drawString("A few soccer balls by yuyang_su", 20,20);
    }
